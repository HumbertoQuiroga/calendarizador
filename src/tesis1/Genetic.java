...
private Catalogo annealing(Catalogo cat1, int costoSalida){
      ...
      do{
          ...
          if(ciclos%100==0){
            System.out.print(ciclos+",  ");
            cat1.evaluaCosto().imprimeCosto();
System.out.println("mejor opci�n ="+mejorOpcionGlobal.getCosto().getCostoTotal()+",  cambios ="+cambios);cambios=0;
          }

          ciclos++;

          //Actualiza Temperatura
          if(ciclos%ENFR==0){temp=temp*factEnfr;}
...
/************************************************************************/
  ...
  private void tabu(){
      ...
      do{
        ...
        System.out.print(ciclos++ +",  "); indActual.getCosto().imprimeCosto();
